...
namespace QualityBags.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, Address = model.Address, Name = model.Name, PhoneNoHome = model.PhoneNoHome, PhoneNoMobile = model.PhoneNoMobile, Enabled = true };
